          ...
          <div style={{
            ...
            <div style={{display: 'flex', gap: '1.5rem'}}>
              {studentDetails.photo ? (
                <img 
                  src={`http://${window.location.hostname}:8000${studentDetails.photo}`} 
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '1rem'}}>
              {selectedAlert.snapshot && (
                <div style={{width: '100%', textAlign: 'center', backgroundColor: '#f0f0f0', borderRadius: '8px', padding: '1rem'}}>
                  <img 
                    src={selectedAlert.snapshot.startsWith('http') ? selectedAlert.snapshot : `http://${window.location.hostname}:8000${selectedAlert.snapshot}`} 
                    alt="Alert Snapshot" 
              ...
              {selectedAlert.student_photo && (
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem', marginTop: '0.5rem'}}>
                  <img 
                    src={selectedAlert.student_photo.startsWith('http') ? selectedAlert.student_photo : `http://${window.location.hostname}:8000${selectedAlert.student_photo}`} 
                    alt="Registered Face" 
